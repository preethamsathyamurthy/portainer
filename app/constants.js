...
export const API_ENDPOINT_AUTH = BASE_URL + 'api/auth';
export const API_ENDPOINT_BACKUP = BASE_URL + 'api/backup';
export const API_ENDPOINT_CUSTOM_TEMPLATES = BASE_URL + 'api/custom_templates';
export const API_ENDPOINT_EDGE_GROUPS = BASE_URL + 'api/edge_groups';
export const API_ENDPOINT_EDGE_JOBS = BASE_URL + 'api/edge_jobs';
export const API_ENDPOINT_EDGE_STACKS = BASE_URL + 'api/edge_stacks';
export const API_ENDPOINT_EDGE_TEMPLATES = BASE_URL + 'api/edge_templates';
export const API_ENDPOINT_ENDPOINTS = BASE_URL + 'api/endpoints';
export const API_ENDPOINT_ENDPOINT_GROUPS = BASE_URL + 'api/endpoint_groups';
export const API_ENDPOINT_KUBERNETES = BASE_URL + 'api/kubernetes';
export const API_ENDPOINT_MOTD = BASE_URL + 'api/motd';
export const API_ENDPOINT_REGISTRIES = BASE_URL + 'api/registries';
export const API_ENDPOINT_RESOURCE_CONTROLS = BASE_URL + 'api/resource_controls';
export const API_ENDPOINT_SETTINGS = BASE_URL + 'api/settings';
export const API_ENDPOINT_STACKS = BASE_URL + 'api/stacks';
export const API_ENDPOINT_STATUS = BASE_URL + 'api/status';
export const API_ENDPOINT_SUPPORT = BASE_URL + 'api/support';
export const API_ENDPOINT_USERS = BASE_URL + 'api/users';
export const API_ENDPOINT_TAGS = BASE_URL + 'api/tags';
export const API_ENDPOINT_TEAMS = BASE_URL + 'api/teams';
export const API_ENDPOINT_TEAM_MEMBERSHIPS = BASE_URL + 'api/team_memberships';
export const API_ENDPOINT_TEMPLATES = BASE_URL + 'api/templates';
export const API_ENDPOINT_WEBHOOKS = BASE_URL + 'api/webhooks';
